...
<body>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col mt-10 w-100">
                <img alt="SEP" src="images/logoSEP.png" class="w-100 h-60" />
            </div>
            <div class="col mt-10">
        ...
        <div class="row mt-10">
            <div class="col">
                ...
                <label>INSTITUCIÓN:</label><br/><br/>
                <label>AÑO:</label><br/><br/><br/>
                <label>Titular de la Institución</label><br/><br/>
                <label>Coordinador de Control Interno</label><br/><br/>
                <label>Enlace de Administración de Riesgos</label>
            </div>
            <div class="col">
                <select placeholder='Selecione' class=''>
                ...
                <input class="form-control" type="date" placeholder="Ingresar el año (4 dígitos)"/><br/>
                <input class="form-control" placeholder="Nombre y Apellidos de la titular"/><br/>
                <input class="form-control" placeholder="Nombre y Apellidos del Coordinador"/><br/>
